namespace Game.Engine.Core
{
    ...
    public class WorldBody : IActor
    {
        ...
        {
            public CollisionResponse(bool canCollide = false, bool hasImpact = false, float frictionCoefficient = 0f)
            {
        ...
        public void WriteSimulation()
        {
            ...
            if (float.IsNaN(Position.X)
                ...
                || float.IsNaN(LinearVelocity.X)
                || float.IsNaN(LinearVelocity.Y)
                ...
                {
                    Console.Error.WriteLine("Invalid object contains NaN, destroying");
