...
if(hasStylesScss&&hasSpriteModeMap&&hasStylesScss){//new theme
...
(<any>window).getTextureMapRules=function(){return textureMapRules};
(<any>window).getModeMapRules=function(){return spriteModeMapRules};
load();
