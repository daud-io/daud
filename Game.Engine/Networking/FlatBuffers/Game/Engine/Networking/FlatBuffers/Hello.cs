...
public struct Hello : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static Hello GetRootAsHello(ByteBuffer _bb) { return GetRootAsHello(_bb, new Hello()); }
  public static Hello GetRootAsHello(ByteBuffer _bb, Hello obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
